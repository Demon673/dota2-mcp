...
- **vconsole2 GUI 必须连接到 `127.0.0.1:29001`**（而不是默认的 `29000`）
- **Dota 2 的 VConsole2 连接（端口 `29000`）必须可用**

> 以上两条端口连接是 MCP 工作的**最基础条件**。如果 `29000`（Dota 2）或 `29001`（vconsole2 GUI）没有正确连接，所有工具都无法使用。
