...
Every active Agent Note follows one in-file format (a convention, with no verifier script; [doc-standards](../../.agents/skills/doc-standards/SKILL.md) and the global archive-agent-notes skill enforce it).
